...
REQUEST_COUNT = Counter('notification_requests_total', 'Total HTTP Requests', ['method', 'endpoint', 'status'])
REQUEST_LATENCY = Histogram('notification_request_duration_seconds', 'HTTP Request Duration', ['method', 'endpoint'])
