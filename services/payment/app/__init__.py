...
REQUEST_COUNT = Counter('payment_requests_total', 'Total HTTP Requests', ['method', 'endpoint', 'status'])
REQUEST_LATENCY = Histogram('payment_request_duration_seconds', 'HTTP Request Duration', ['method', 'endpoint'])
